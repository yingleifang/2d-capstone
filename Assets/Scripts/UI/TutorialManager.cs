...
public class TutorialManager : MonoBehaviour
{
    ...
    private static string[] lines1 = {
        ...
        "Clicking an ally will highlight possible hexagons it can move to in blue.  Double click hexagons to move to them. For now, move your unit to the red hexagon.",
